...
export function StalkingPage() {
    ...
    return (
        <main className="flex pt-4 justify-center h-[90vh]">
                                            ...
                                            <Card variant="horizontal" className="relative gap-2 items-center w-full max-md:flex-col">
                                                ...
                                                <Card.Body className="w-full">
                                                    ...
                                                    <div className="flex gap-2">
                                                        ...
                                                        <Link href={stalked.html_url} target="_blank" className="w-full flex gap-2 justify-center items-center rounded-[4px] bg-indigo-500 hover:bg-indigo-400 duration-150" >
            ...
            {
                selectedStalked && (
                    <div className="flex justify-center items-center py-4 fixed inset-0 w-screen h-screen bg-white z-[999] overflow-y-auto scrollbar-hide">
                        <div className="bg-zinc-950 flex flex-col p-8 gap-4 rounded-lg h-fit w-2/5 max-md:w-11/12">
