                ...
                <div className='bg-white fixed top-0 left-0 bottom-0 right-0 z-[999] pb-8 overflow-scroll overscroll-contain scrollbar-hide'>
                    <div className='relative text-xl font-semibold text-white bg-slate-900 flex flex-col gap-4 m-auto mt-8 w-[50vw] min-w-[300px] p-8 rounded-md'>
                        ...
                        <div className='flex flex-col gap-2 justify-center'>
                            ...
                            <h1 className='min-h-[48px] bg-gray-50 text-gray-900 text-base font-medium p-2 rounded-md transition hover:bg-opacity-80'>{repository.description}</h1>
                        </div>
                        <div className='flex justify-between'>
                            <figure className='flex flex-col items-center'>
                                ...
                                <figcaption className='flex flex-col gap-1 text-center'>
                                    ...
                                    <h1 className='text-base font-medium'>Dia {getDate(repository.created_at)} às {getTime(repository.created_at)} hr</h1>
                                </figcaption>
                            </figure>
                            <figure className='flex flex-col items-center'>
                        ...
                        <div className='flex gap-4 justify-between'>
                            <figure className='flex flex-col gap-2 items-center w-[30%] text-center'>
                                <div className='bg-green-700 animate-pulse w-[128px] h-[128px] text-4xl flex items-center justify-center rounded-[100%]'>{repository.stargazers_count}</div>
                                <figcaption>Estrelas</figcaption>
                            </figure>
                            <figure className='flex flex-col gap-2 items-center w-[30%] text-center'>
                                <div className='bg-green-500 animate-pulse w-[128px] h-[128px] text-4xl flex items-center justify-center rounded-[100%]'>{repository.watchers_count}</div>
                                <figcaption>Visualizações</figcaption>
                            </figure>
                            <figure className='flex flex-col gap-2 items-center w-[30%] text-center'>
                                <div className='bg-green-300 animate-pulse w-[128px] h-[128px] text-4xl flex items-center justify-center rounded-[100%]'>{repository.forks_count}</div>
