...
export function Card({ data }) {
    return (
        <div className='text-xl font-semibold text-white bg-slate-900 flex flex-col gap-4 w-[50vw] min-w-[300px] p-8 rounded-md'>
            ...
            <div className='flex justify-between'>
                <figure className='flex flex-col items-center'>
                    ...
                    <figcaption className='flex flex-col gap-1 text-center'>
                        ...
                        <h1 className='text-base font-medium'>Dia {getDate(data.created_at)} às {getTime(data.created_at)} hr</h1>
                    </figcaption>
                </figure>
                <figure className='flex flex-col items-center'>
                    ...
                    <figcaption className='flex flex-col gap-1 text-center'>
                        ...
                        <h1 className='text-base font-medium'>Dia {getDate(data.updated_at)} às {getTime(data.updated_at)} hr</h1>
                    </figcaption>
                </figure>
            </div>
